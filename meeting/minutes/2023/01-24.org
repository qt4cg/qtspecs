...
+ DN: In MK’s absence, I’m not sure we can discuss this, but I would
  ...
  concise and what’s missing is that defaults should be lazy by
  default. That was the construtive part. There was a lot of
  ...
  + … Maybe they aren’t exactly the same, but there’s some experience
    that they exist.
