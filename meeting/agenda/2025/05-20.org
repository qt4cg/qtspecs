:PROPERTIES:
:ID:       53BE701D-9026-4A29-B439-FEAB374C39A3
:END:
#+title: QT4 CG Meeting 122 Agenda 2025-05-20
...
Minutes of [[../../minutes/2025/05-13.html][the previous meeting]].
...
This meeting is planned for 20 May 2025. The following meeting is scheduled
for 27 May 2025. 

The meeting after that is 3 June, the same week as MarkupUK. I’m tempted to
suggest that we skip that week.
...
+ PR [[https://qt4cg.org/dashboard/#pr-2001][#2001]]: 1085 Revert fn:sort to the 3.1 spec; introduce fn:sort-by
+ PR [[https://qt4cg.org/dashboard/#pr-1991][#1991]]: 835 Add built-in named record types to static context
+ PR [[https://qt4cg.org/dashboard/#pr-2008][#2008]]: 2004 Add xsl:xpath instruction
+ PR [[https://qt4cg.org/dashboard/#pr-2006][#2006]]: 2005 Add fn:apply-templates function
...
+ Issue [[https://github.com/qt4cg/qtspecs/issues/2009][#2009]]: xsl:variable implicit document nodes
+ Issue [[https://github.com/qt4cg/qtspecs/issues/2007][#2007]]: Creating arrays in XSLT
+ Issue [[https://github.com/qt4cg/qtspecs/issues/2005][#2005]]: apply-templates() as a function
...
+ Issue [[https://github.com/qt4cg/qtspecs/issues/1995][#1995]]: Consistency: numeric array lookups
