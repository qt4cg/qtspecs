:PROPERTIES:
:ID:       21374DD0-B629-4DB5-B5D9-4230ABFDB6DA
:END:
#+title: QT4 CG Meeting 119 Agenda 2025-04-29
...
Minutes of [[../../minutes/2025/04-22.html][the previous meeting]].
...
This meeting is planned for 29 April 2025. The following meeting is scheduled
for 6 May 2025. 
...
+ Issue [[https://github.com/qt4cg/qtspecs/issues/1958][#1958]]: Typo in map:build
+ Issue [[https://github.com/qt4cg/qtspecs/issues/1957][#1957]]: Schema for XSLT incorrectly allows mixed content for xsl:output
+ Issue [[https://github.com/qt4cg/qtspecs/issues/1955][#1955]]: fn:doc, fn:parse-xml: entity expansion
+ Issue [[https://github.com/qt4cg/qtspecs/issues/1954][#1954]]: Private fields in records
+ Issue [[https://github.com/qt4cg/qtspecs/issues/1952][#1952]]: Change option name from xsi-schema-location to use-xsi-schema-location
+ Issue [[https://github.com/qt4cg/qtspecs/issues/1951][#1951]]: Some nits regarding the method attribute
...
:PROPERTIES:
:CUSTOM_ID: h-CAE7E947-A188-4C20-9CF1-84DCF22E9C16
:END:
