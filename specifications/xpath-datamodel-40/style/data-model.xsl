...
<xsl:template match="processing-instruction('xdm-accessor-summary')">
  <xsl:variable name="app-num">
    <xsl:number value="count(../preceding-sibling::div1 | ../preceding-sibling::inform-div1) + 1" format="A"/>
  </xsl:variable>
...
<xsl:template match="processing-instruction('xdm-infoset-construction-summary')">
  <xsl:variable name="app-num">
    <xsl:number value="count(../preceding-sibling::div1 | ../preceding-sibling::inform-div1) + 1" format="A"/>
  </xsl:variable>
...
<xsl:template match="processing-instruction('xdm-psvi-construction-summary')">
  <xsl:variable name="app-num">
    <xsl:number value="count(../preceding-sibling::div1 | ../preceding-sibling::inform-div1) + 1" format="A"/>
  </xsl:variable>
...
<xsl:template match="processing-instruction('xdm-infoset-mapping-summary')">
  <xsl:variable name="app-num">
    <xsl:number value="count(../preceding-sibling::div1 | ../preceding-sibling::inform-div1) + 1" format="A"/>
  </xsl:variable>
